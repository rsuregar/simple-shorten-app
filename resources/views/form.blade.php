        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                ...
                <form action="{{ route('form.store') }}" method="post">
                    @csrf
                    <input type="text" name="origin_link" placeholder="Paste your long link here" value="{{ old('origin_link') }}">
                ...
                yang baru dibuat : {{ $link ?? '' }}

            <hr>
            ini semuanya
           <ol>
               @foreach ($links as $item)
                   <li><a href="{{ url('/', $item->short_link) }}" target="_blank">{{ url('/', $item->short_link) }}</a></li>
               @endforeach
           </ol>
            </div>
